 ...
 * - Substrate provides a multisig dispatch function
 *    in its Utility pallet.
 * - This example generates the address that would correspond
 *    to a set of addresses and threshold.
 */
const {
  createKeyMulti,
  encodeAddress,
